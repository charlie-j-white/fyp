...
C   variations   of useful results: res1 res2 res3
C   with respect to varying inputs: ue um ur arearat
C   RW status of diff variables: ue:in um:in ur:in res1:out res2:out
C                res3:out arearat:in
C***********************************************************************
C
C                               j R E S 
C      
...
C     subroutine jRES(ni,ur,um,ue,dx,ds,area,pk,res1,res2,res3)
      SUBROUTINE JRES_D(ni, ur, urd, um, umd, ue, ued, pk, res1, res1d, 
     +                  res2, res2d, res3, res3d, arearat, arearatd)
      IMPLICIT NONE
C
      INTEGER ni, nj
