...
!     get dRdu
      ...
      flowd(1,1) = 1.0d0
      call JRES_D(ni, pk, arearat, 0.0d0, residual, dRdu2, flow, flowd)
      fluxjac2(1,:) = dRdu2(1,:)
...
!     get dRda
      call JRES_D(ni, pk, arearat, 1.0d0, residual, dRda2, flow, flowd)
...
!     print all flux jacobian elements from a specific row

!      print*, "      "
!      print*, "      "
!      do ii=1,3*ni+9
!        print*, ii, fluxjac2(4,ii)
!      end do
